...
// Gist: The prototype pattern is a creational design pattern in software development.
...
//  virtual clone() method. Any class that needs a "polymorphic constructor" capability
//  derives itself from the abstract base class, and implements the clone() operation.
//
// from https://en.wikipedia.org/wiki/Prototype_pattern
...
class Rectangle implements Shape {
  ...
  int get hashCode {
    ...
    return _hashCode = DateTime.now().millisecondsSinceEpoch;
  }
